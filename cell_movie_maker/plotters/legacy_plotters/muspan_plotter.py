...
class MuspanPCFPlotter:
    ...
    def plot_tcell_tcell_pcf(fig, ax, pc, *, config=None):
        ...
        radii, g, contributions = ms.statistics.pairCorrelationFunction(
            pc,'Celltype',['T Cell','T Cell'], **config.pcf_kwargs)
    ...
    def plot_tcell_tumour_pcf(fig, ax, pc, *, config=None):
        ...
        radii, g, contributions = ms.statistics.pairCorrelationFunction(
            pc,'Celltype',['T Cell','Tumour'], **config.pcf_kwargs)
        fig, ax = ms.visualise.plotPCF(
    ...
    def plot_tumour_tumour_pcf(fig, ax, pc, *, config=None):
        ...
        radii, g, contributions = ms.statistics.pairCorrelationFunction(
            pc,'Celltype',['Tumour','Tumour'], **config.pcf_kwargs)
        fig, ax = ms.visualise.plotPCF(
    ...
    def plot_vessel_vessel_pcf(fig, ax, pc, *, config=None):
        ...
        radii, g, contributions = ms.statistics.pairCorrelationFunction(
            pc,'Celltype',['Blood Vessel','Blood Vessel'], **config.pcf_kwargs)
        fig, ax = ms.visualise.plotPCF(
    ...
    def plot_tumour_vessel_pcf(fig, ax, pc, *, config=None):
        ...
        radii, g, contributions = ms.statistics.pairCorrelationFunction(
            pc,'Celltype',['Tumour','Blood Vessel'], **config.pcf_kwargs)
        fig, ax = ms.visualise.plotPCF(
...
class MuspanWeightedPCFPlotter:
    ...
    def plot_potency_tumour_pcf(fig, ax, pc, config=None):
        ...
        PCF_radii_lower, targetP, wPCF = ms.statistics.weightedPairCorrelationFunction(
            pc,'Celltype','Tumour','potency', **config.pcf_kwargs)
    ...
    def plot_damage_tcell_pcf(fig, ax, pc, config=None):
        ...
        PCF_radii_lower, targetP, wPCF = ms.statistics.weightedPairCorrelationFunction(
            pc,'Celltype','T Cell','damage', **config.pcf_kwargs)
        fig, ax = ms.visualise.plotWeightedPCF(PCF_radii_lower, targetP, wPCF, ax=ax)
        ax.set_xlim(xmin=0, xmax=1)
        ax.set_ylim(ymin=0)
        ax.yaxis.set_major_formatter(FormatStrFormatter('%.2f'))
