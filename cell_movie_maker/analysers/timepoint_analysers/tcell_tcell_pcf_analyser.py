...
class TCellTCellPCFAnalyser(TimepointAnalyser):
    ...
    def analyse(self, timepoint:SimulationTimepoint)->pd.DataFrame|pd.Series|float|int:
        ...
        p1 = ms.query.interpret_query(ms.query.query(domain, "cell_type", "is", "T Cell"))
    ...
    def __str__(self):
        return f'TCell-TCell PCF r={self.r_max} dr={self.dr} step={self.step}'
